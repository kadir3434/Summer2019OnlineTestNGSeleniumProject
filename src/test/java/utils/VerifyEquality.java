...
public class VerifyEquality {

    public static void verifyEquality(String expectedResult, String actualResult) {
    ...
    public static void verifyEquality(String expectedResult, String actualResult, boolean visible){
